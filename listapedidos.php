<?php
    ...
    if (isset($_POST['add_to_cart'])) {
        if (isset($_SESSION['cart'])) {
            ...
            // Descripcion del proceso de la lista de compras
...
<!-- Diseño del frontend de la lista de productos del carrito -->
<body>
<div class="container-fluid">
        <div class="col-me-12">
            ...
            <div class="col-md-12"><br>
                    ...
                    //Diseño del formulario que va con el frontend de la lista de productos del carrito
